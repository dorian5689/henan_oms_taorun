...
class RunSxz(object):
    def __init__(self, username=None, password=None, wfname=None, userid=None, wfname_id=None, start_run_time=None):
        ...
        self.message_dl = {
            ...
            "markdown": {
                "title": "OMS推送",
                "text":
                    F'第{self.wfname_id}个场站:{self.wfname}--已上报--电量--现场'
            }
        }
        self.message_cn = {
            "msgtype": "markdown",
            "markdown": {
                "title": "OMS推送",
                "text":
                    F'第:{self.wfname_id}个场站:{self.wfname}--已上报--储能--现场'
            }
        }
    ...
    def report_load_cn(self, table0, henan_oms_data):
        ...
        if self.today_1 == table0.ele(F'{henan_ele_dict.get("upload_date_cn")}').text:
